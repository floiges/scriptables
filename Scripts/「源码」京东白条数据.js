...
class Widget extends ScriptableWidget {
	...
	async renderSmall(data) {
		...
		bg.locations = [0, 1];
		bg.colors = [new Color('#f35942', 1), new Color('#e92d1d', 1)];
	...
	async renderMedium(data) {
		...
		w.backgroundImage = await this.getImageByUrl(
			'https://txc.gtimg.com/data/287371/2020/1124/30e1524a9288442bec9243c9afa40e90.png',
		);
	...
	async actionOpenUrl() {
		Safari.openInApp(
			'https://mcr.jd.com/credit_home/pages/index.html?btPageType=BT',
			false,
		);
	}
}
